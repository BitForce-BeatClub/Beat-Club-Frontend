...
import SessionSecurity from "../services/security/session-auth.service";
...
export default {
  ...
  mounted() {
    // CountryService.getCountr ies().then((res) => (this.countries = res));
  },
  methods: {
    signUp(isFormValid) {
      this.submitted = true;
      ...
      this.toggleDialog();
      console.log(SessionSecurity.getCurrentToken());
    },
    toggleDialog() {
